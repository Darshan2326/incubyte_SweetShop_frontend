...
//     // State to track purchase quantities for each sweet
...
//     // Handle change in purchase quantity for a specific sweet
//     const handlePurchaseQuantityChange = (sweetId, value) => {
//         setPurchaseQuantities(prev => ({
//             ...prev,
//             [sweetId]: Math.max(1, parseInt(value) || 1) // Minimum quantity is 1
//         }));
//     };

//     // Handle purchase of a sweet
...
//             // Update the sweet's quantity in the UI
...
//                 <h1 style={styles.title}>🍰 Sweet Delights Shop</h1>
//                 <p style={styles.subtitle}>Browse our delicious collection of sweets</p>
//                 <button
...
//                 {sweets.length === 0 ? (
//                     <div style={styles.noSweets}>No sweets available at the moment.</div>
//                 ) : (
//                     sweets.map((sweet) => (
...
//                                     <span style={styles.sweetPrice}>${sweet.price.toFixed(2)}</span>
//                                     <span style={styles.sweetQuantity}>
...
//                                             ...(sweet.quantity === 0 ? styles.disabledButton : {})
//                                         }}
